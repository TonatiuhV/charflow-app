<nav class="dark:bg-gray-800 border-b">
        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex flex-shrink-0 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="block h-8 w-auto lg:hidden"
                        viewBox="0 0 16 16">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="hidden h-8 w-auto lg:block"
                        viewBox="0 0 16 16">
                        <path
                            d="M2 1a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6.5a.5.5 0 0 1-1 0V1H3v14h3v-2.5a.5.5 0 0 1 .5-.5H8v4H3a1 1 0 0 1-1-1V1Z" />
                        <path
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('chartflow') }}"
                            class="rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('chartflow') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                            aria-current="page">chartflow</a>
                        <a href="{{ route('home') }}"
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button type="button"
                    class="rounded-full dark:bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                ...
                <div class="relative ml-3">
                    <div>
                        {{-- <button type="button"
                            class="flex rounded-full dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            ...
            text-base font-medium {{ request()->routeIs('home') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                aria-current="page">Home</a>
            <a href="{{ route('chartflow') }}"
                class=" block rounded-md px-3 py-2
            text-base font-medium {{ request()->routeIs('home') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
